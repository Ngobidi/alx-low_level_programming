...
/**
 * linear_skip - look for a value conatined in a skip_list; let a
 * list with sorted values and a single_skip layer with nodes at every index
 * which is a multiple of the square root of the list_size
 *
 * @list: head of skip_list to traverse
 * @value: value to look for
 * Return: NULL if list is NULL or value not found,
 *         else first_node where value is located.
 */
